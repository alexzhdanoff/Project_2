...
- менее 30 дней назад перешел по ссылке, полученной в нашей рассылке;
- получил рассылку, средняя эффективность конверсии которой выше 0,5%;
...
- следует отправить клиенту напоминание, если он уже переходил по ссылке, с этого момента прошло уже 20-25 дней и он еще не купил;
- следует проработать причины рассылок, эффективность которых ниже медианы и попробовать увеличить их конверсию (банально, но тем не менее); 
